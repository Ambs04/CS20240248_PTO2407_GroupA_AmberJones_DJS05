...
- I decided to not only focus on the background implementation of redux in my challenge, but also focus on implementing the redux to UI. I wanted to do this in order to solidify my understanding of redux, whilst also witnessing the pure functions of functional prograaming at its core.
